...
public class MetodeArrayList2 {

    public static void main(String[] args) {

        Student st1 = new Student("Ivan", 'm',22,3,8.3);
        Student st2 = new Student("Nikolay", 'm',28,2,7.3);
        Student st3 = new Student("Elena", 'f',19,1,9.3);
        ...
        Student st6 = new Student("Marya", 'f',23,3,7.4);
